...
**Note:** This command assumes your project has a `CLAUDE.md` file organized in sections (General/Backend/Frontend). If your project uses a different documentation structure, adapt the prompt accordingly.
